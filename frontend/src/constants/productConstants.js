export const ALL_PRODUCT_REQUEST = "ALL_PRODUCT_REQUST";
...
export const ADMIN_PRODUCT_REQUEST = "ADMIN_PRODUCT_REQUST";
...
export const DELTE_PRODUCT_REQUEST = "DELTE_PRODUCT_REQUEST";
export const DELTE_PRODUCT_SUCCESS = "DELTE_PRODUCT_SUCCESS";
export const DELTE_PRODUCT_RESET = "DELTE_PRODUCT_RESET";
export const DELTE_PRODUCT_FAIL = "DELTE_PRODUCT_FAIL";
