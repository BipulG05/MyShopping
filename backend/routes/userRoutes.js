...
const { registerUser, loginUser, logout, forgetPassword, resetPassword, getUserDetails, updateUserPassword, updateUserDetails, getAllUser, getUserProfile, updateUserRole, deleteUser } = require('../controllers/userControler');
